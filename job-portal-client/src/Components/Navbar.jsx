    ...
    <header className="bg-white shadow-md fixed w-full z-50">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center">
          <img className="h-12" src="https://th.bing.com/th/id/OIP.Dy70nxVD0Xw0UuSd9HUdcAHaFj?w=260&h=195&c=7&r=0&o=5&dpr=1.5&pid=1.7" alt="logo" />
          <span className="text-xl font-bold ml-3">Job Portal</span>
        </div>
        <div className="lg:hidden">
          <button onClick={handleMenu} className="text-gray-700 focus:outline-none">
            {isMenuOpen ? (
